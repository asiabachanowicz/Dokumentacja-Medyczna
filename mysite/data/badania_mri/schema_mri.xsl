	...
	<xsl:template match="hl7:Document">
		<html>
			...
			<body>
				...
				<div class="imageDiv">
					<p>Obraz badania medycznego</p>
					<img id="imageOfExamination" src="https://dworska.pl/images/rezonans_mri/rezonans_kregoslupa/rezonans-kregoslupa-szyjnego-krakow.png" alt="Image of medical examination"/>
					<p>Opis badania</p>
				</div>
